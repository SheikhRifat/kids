...
import 'dart:math';
import 'dart:io';
import 'package:kids/src/PDF/PdfViewer.dart';
import 'package:kids/src/customWidget/MainScreenCard.dart';
...
class PdfGenerationScreen extends StatefulWidget {
  ...
  PdfGenerationScreen({ required this.icon, this.operator}) ;
