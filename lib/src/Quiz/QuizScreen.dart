...
import 'package:kids/src/Quiz/AnswerScreen.dart';
import 'package:kids/src/customWidget/QuizButtonIcon.dart';
...
class QuizScreen extends StatefulWidget {
  ...
  QuizScreen({this.duration,this.oprator="sum", this.numOfQuestions = "5", this.range1 = "5", this.range2 = "5"});
